...
@StructuredPrompt("You are a large language model trained on a masive dataset of musiclist and user preferences\n" +
        ...
        "]")
@Data
public class GeminiPromptByKeySearch {
    private List<GeminiMusicEmotion> musicemotion;
    private List<GeminiMusicYear> musicyear;
    private List<GeminiMusicType> musictype;
